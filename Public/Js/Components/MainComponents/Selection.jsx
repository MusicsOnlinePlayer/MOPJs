...
import { HIST_CONTEXT, SELECT_CONTEXT } from "../../Constants/MusicsConstants";
...
class Selection extends React.Component {
  ...
  componentDidMount() {
    ...
    Axios.get(`/User/Selection/`).then((res) => {
      this.setState({
        Musics: res.data,
      });
    });
  ...
  OnMoreClick = () => {
    ...
    Axios.get(
      `/User/ViewedMusics?PerPage=${Size}&Page=${CurrentPage + 1}`
    ).then((res) => {
